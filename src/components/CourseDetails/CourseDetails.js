...
const CourseDetails = (props) => {
    ...
    //here i tried to do this using filter/map to filter the data with given ID. 
    //but i failed to do so. So ekta fokira way te just particular course er
    //naam ta show koraisi. I would really appreciate if you could show me
